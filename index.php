...
<body>
	...
	<div id="app">
		...
		<div class="container mt-3">
			...
			<button type="button" data-toggle="modal" data-target="#modal-tambah" class="btn btn-primary mb-3" @click="resetForm(); changeModal('modal-tambah')">Tambah Data</button>
	...
	<footer>
		<div class="container text-center mt-5">
			<p class="small">VUE JS PHP CRUD</p>
			<p><a target="_blank" href="github.com/myusron12" title="Lihat author" style="color: #333">github</a> &copy; <?= date('Y') ?></p>
		</div>
	</footer>
